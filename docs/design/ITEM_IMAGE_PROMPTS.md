...
作成: 2026-08-09 / 作成者: Claude Code / 対象: ver.4.1.0 のショップ・装備アイテム 全20点

現在アイテムは**テキストのみ**で表示されている。ここに1点ずつアイコン画像を添えるための
生成プロンプトをまとめた。**画像生成が得意なAI(Gemini / Imagen / ChatGPT画像生成など)で
このファイルの指示をそのまま使う**ことを想定している。
...
画像を20点つくりたいです。アプリの世界観は「黒 × ゴールド」で、ダンスとステージが
モチーフです。
